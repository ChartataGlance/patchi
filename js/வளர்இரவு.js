...
function showPosition(pos) {
   ...
   document.getElementById("இரண்டாவதுசாமம்வளர்இரவுசாவு").innerText = "Untill " + `${convertToStamp(srt,  924)}`;//12
	document.getElementById("இரண்டாவதுசாமம்வளர்இரவுநடை").innerText = "Untill " + `${convertToStamp(srt, 960)}`;//36
	document.getElementById("இரண்டாவதுசாமம்வளர்இரவுதுயில்").innerText = "Untill " + `${convertToStamp(srt, 978)}`;//18
	document.getElementById("இரண்டாவதுசாமம்வளர்இரவுஊண்").innerText = "Untill " + `${convertToStamp(srt, 1008)}`;//30


	document.getElementById("மூன்றாவதுசாமம்வளர்இரவுசாவு").innerText = "Untill " + `${convertToStamp(srt, 1020)}`;//12
	document.getElementById("மூன்றாவதுசாமம்வளர்இரவுநடை").innerText = "Untill " + `${convertToStamp(srt, 1056)}`;//36
	document.getElementById("மூன்றாவதுசாமம்வளர்இரவுதுயில்").innerText = "Untill " + `${convertToStamp(srt, 1074)}`;//18
	document.getElementById("மூன்றாவதுசாமம்வளர்இரவுஊண்").innerText = "Untill " + `${convertToStamp(srt, 1104)}`;//30
   document.getElementById("மூன்றாவதுசாமம்வளர்இரவுஅரசு").innerText = "Untill " + `${convertToStamp(srt, 1152)}`;//48


	document.getElementById("நான்காவதுசாமம்வளர்இரவுநடை").innerText = "Untill " + `${convertToStamp(srt, 1188)}`;//36
	document.getElementById("நான்காவதுசாமம்வளர்இரவுதுயில்").innerText = "Untill " + `${convertToStamp(srt, 1206)}`;//18
	document.getElementById("நான்காவதுசாமம்வளர்இரவுஊண்").innerText = "Untill " + `${convertToStamp(srt, 1236)}`;//30
